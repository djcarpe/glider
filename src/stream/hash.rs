...
//!
//! Here because SigV4 needs them and glider has no dependencies. Both are
//! short, frozen, and exhaustively specified — FIPS 180-4 and RFC 2104 have
//! not changed since before most of us started writing code, and the test
//! vectors below are the published ones.
//!
//! This is a signing primitive, not a security boundary: it authenticates
//! requests to object storage. Do not reach for it to hash passwords.
...
mod tests {
    ...
    fn sha256_published_vectors() {
        ...
        // Crosses several blocks and exercises the length encoding.
