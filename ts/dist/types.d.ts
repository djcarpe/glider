...
export declare function isNode(c: Cell): c is GliderNode;
/** Narrow a cell to a relationship. */
export declare function isRel(c: Cell): c is GliderRel;
/** Thrown for any failure reported by the engine. */
export declare class GliderError extends Error {
